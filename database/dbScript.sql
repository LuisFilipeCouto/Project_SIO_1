...
-- USERS
INSERT INTO `film_review`.`users` (id, username, email, isAdmin, passwordHash)
VALUES (1,"Bernardo Bento","nardoben@mail.com",0,"password");

INSERT INTO `film_review`.`users` (id, username, email, isAdmin, passwordHash)
VALUES (2,"Gonçalo Neves","goncas@mail.com",0,"wordpass");
