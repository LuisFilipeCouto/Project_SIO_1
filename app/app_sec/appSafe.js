...
// User Register ---> Not Vulnerable to CWE-759: Use of a One-Way Hash without a Salt
// User Register ---> Not Vulnerable to  CWE-328: Use of Weak Hash
...
// Alter password ---> Not Vulnerable to CWE-759: Use of a One-Way Hash without a Salt
// Alter password ---> Not Vulnerable to CWE-328: Use of Weak Hash
...
// Find movies by title ---> Not Vulnerable to CWE-89: Improper Neutralization of Special Elements used in an SQL Command ('SQL Injection')
...
// Post comment on movie ---> Not Vulnerable to CWE-79: Improper Neutralization of Input During Web Page Generation ('Cross-site Scripting')
...
// Give a movie a rating x out of 5 ---> Not Vulnerable to CWE-20
